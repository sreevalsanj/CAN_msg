...
class Dataa:
    ...
    def spe(self):
        ...
        if self.message.arbitration_id==0x201:
            ...
            op = self.to_little(self.he[0:4])
            self.sternAngle= int(self.he[0:4],16)
